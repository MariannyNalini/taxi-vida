...
if ( defined('DEMO_MODE') && isset($_GET['woocommerce_sidebar_position']) ) {
  $mariann_theme_options['woocommerce_sidebar_position'] = $_GET['woocommerce_sidebar_position'];
}

if(isset($mariann_theme_options['woocommerce_sidebar_position'])) {
	$page_sidebarposition = $mariann_theme_options['woocommerce_sidebar_position'];
} else {
		...
		<div class="row">
			<div class="col-md-12">
				<div class="page-item-title-archive">
					...
					<h1><?php if(woocommerce_page_title(false) == '') { echo esc_html_('Shop', 'mariann'); } else { woocommerce_page_title(); } ?></h1>
				</div>
			</div>
		</div>
	</div>
