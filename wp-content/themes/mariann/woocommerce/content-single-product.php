...
if ( defined('DEMO_MODE') && isset($_GET['woocommerce_product_sidebar_position']) ) {
  $mariann_theme_options['woocommerce_product_sidebar_position'] = $_GET['woocommerce_product_sidebar_position'];
}

if(isset($mariann_theme_options['woocommerce_product_sidebar_position'])) {
	$page_sidebarposition = $mariann_theme_options['woocommerce_product_sidebar_position'];
} else {
