<?php
	...
	add_action( 'wp_enqueue_scripts', 'mariann_enqueue_dynamic_js', '999' );

	function mariann_enqueue_dynamic_js( ) {
    ...
    $(document).ready(function() {
        ...
        <?php if(isset($mariann_theme_options['custom_js_code'])) { 

        	echo $mariann_theme_options['custom_js_code'];  // This variable contains user Custom JS code and can't be escaped with WordPress functions 
