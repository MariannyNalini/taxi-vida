    ...
    jQuery(document).ready( function( $ ){
		...
		if ( $('#ipanel-preview-wrap').exist() ) {
			$('.ipanel-toggle-preview').on("click", function(e){
			...
			$('.ipanel-devices-nav').find('>ul').find('>li').on("click", function(e){
		...
		$('#ipanel-tabs').find('a').on("click", function(e){
    ...
    $('.ipanel-repeater-new-item').on("click", function(e){
    ...
    $('.ipanel-import-button').on("click", function(e){
