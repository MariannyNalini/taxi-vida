...
<html <?php language_attributes(); ?> class="no-js">
	<head>
		...
		})(window,document,'script','dataLayer','GTM-5XWKSMM');</script>
	...
	<!-- Google Tag Manager (noscript) -->
		<noscript>
			<iframe src="https://www.googletagmanager.com/ns.html?id=GTM-5XWKSMM" height="0" width="0" style="display:none;visibility:hidden"></iframe>
		</noscript>
